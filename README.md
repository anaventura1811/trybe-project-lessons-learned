...
Link p/ o projeto publicado: https://anaventura1811.github.io/minha-jornada/
...
Neste projeto, são desenvolvidas as seguintes habilidades:

* Utilização de _HTML_ para construir páginas WEB.
* Utilização de _HTML_ semântico para tornar sua páigna mais acessível e melhor ranqueada.
* Utilização de _CSS_ para adicionar estilo e posicionar elementos.
